  ...
  1: {
    dayInstructions: 'Your type value tells your reducer what action you\’re sending it. *> If you look at your current reducer, the only action type they can take right now is \'COOK_WAFFLES\'. Try dispatching it an action with that type! *> Note: Your reducers are written with switch statements. If you’re not familliar with them, check out this link: (mdn link)',
    ...
    promptNight : ["function waffleBot ( state = initialState, action ) {" , "&ensp;switch ( action.type ) {" , "&ensp;&ensp;case 'COOK_WAFFLES' :" , "&ensp;&ensp;&ensp;return { waffles : waffles +1 };", "&ensp;&ensp;case <input type=text placeholder='action type' ref='input1'></input>:" , "return { <input type=text placeholder='state slice' ref='input2'></input> : <input type=text placeholder='state slice' ref='input3'></input> +1};", "&ensp;}", "}"],
    reducerData: ['function waffleBot(state = initialState, action){ ', '&ensp;&ensp;switch(action.type){', "&ensp;&ensp;&ensp;&ensp;case 'COOK_WAFFLES':", '&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;return {waffles:waffles +1};', '&ensp;&ensp;&ensp;&ensp;default:', '&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;return state;']
  },
  2: {
    ...
    reducerData: ['function waffleBot(state = initialState, action){ ', '&ensp;&ensp;switch(action.type){', "&ensp;&ensp;&ensp;&ensp;case 'COOK_WAFFLES':", '&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;return {waffles:waffles +1};', "&ensp;&ensp;&ensp;&ensp;case 'COOK_BISCUITS':", '&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;return {biscuits:biscuits +1};', '&ensp;&ensp;&ensp;&ensp;default:', '&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;return state;']
  },
  3: {
    dayInstructions: '',
    nightInstructions: '',
