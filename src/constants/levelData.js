  ...
  1: {
    ...
    promptNight : ["function waffleStation ( state = initialState, action ) {" , "&ensp;switch ( action.type ) {" , "&ensp;&ensp;case 'COOK_WAFFLES' :" , "&ensp;&ensp;&ensp;return { waffles : waffles +1 };", "&ensp;&ensp;case <input type=text></input>:" , "return { <input type=text></input> : <input type=text></input> +1};", "&ensp;}", "}"],
    reducerData: ['function waffleStation(state = initialState, action){ ', '&ensp;&ensp;switch(action.type){', "&ensp;&ensp;&ensp;&ensp;case 'COOK_WAFFLES':", '&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;return {waffles:waffles +1};', '&ensp;&ensp;&ensp;&ensp;default:', '&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;return state;']
  },
  2: {
